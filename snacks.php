...
<header><label class="nombreParte1">Abarrotes</label>
    ...
    <section>
        <!-- Categoria: Snacks y Piqueos -->
    	<center><h1 class="titulo_categoria">Categoria: Snacks y Piqueos</h1></center>
       <div class="container">
	   <?php
                $sql="SELECT * from producto INNER JOIN categoria ON producto.idCategoria = categoria.idCategoria WHERE categoria.nombreCateg LIKE 'Snacks y Piqueos'";
			...
			<form action="carrito.php" method="post">
				...
				<img src="imagenes/categoria/snacks_piqueos/<?php echo $mostrar['idProducto']?>.jpg">
