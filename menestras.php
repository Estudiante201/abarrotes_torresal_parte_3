...
<header><label class="nombreParte1">Abarrotes</label>
    ...
    <section>
        <!-- Categoria: Menestras -->
    	<center><h1 class="titulo_categoria">Categoria: Menestras</h1></center>
       <div class="container">
	   <?php
                $sql="SELECT * from producto INNER JOIN categoria ON producto.idCategoria = categoria.idCategoria WHERE categoria.nombreCateg LIKE 'Menestras'";
			...
			<form action="carrito.php" method="post">
				...
				<img src="imagenes/categoria/menestras/<?php echo $mostrar['idProducto']?>.jpg">
