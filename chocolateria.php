...
<header><label class="nombreParte1">Abarrotes</label>
    ...
    <section>
    	...
    	<center><h1 class="titulo_categoria">Categoria: Chocolatería</h1></center>
       <div class="container">
	   <?php
                $sql="SELECT * from producto INNER JOIN categoria ON producto.idCategoria = categoria.idCategoria WHERE categoria.nombreCateg LIKE 'Chocolatería'";
			...
			<form action="carrito.php" method="post">
				...
				<img src="imagenes/categoria/chocolateria/<?php echo $mostrar['idProducto']?>.jpg">
