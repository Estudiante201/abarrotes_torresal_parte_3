...
<header><label class="nombreParte1">Abarrotes</label>
    ...
    <section>
        <!-- Categoria: Comidas Instantáneas -->
    	<center><h1 class="titulo_categoria">Categoria: Comidas Instantáneas</h1></center>
       <div class="container">
	   <?php
                $sql="SELECT * from producto INNER JOIN categoria ON producto.idCategoria = categoria.idCategoria WHERE categoria.nombreCateg LIKE 'Comidas Instantáneas'";
			...
			<form action="carrito.php" method="post">
				...
				<img src="imagenes/categoria/comida_instantaneas/<?php echo $mostrar['idProducto']?>.jpg">
