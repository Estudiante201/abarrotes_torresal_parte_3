...
<header><label class="nombreParte1">Abarrotes</label>
    ...
    <section>
        <!-- Categoria: Aceite -->
    	<center><h1 class="titulo_categoria">Categoria: Aceite</h1></center>
       <div class="container">
	   <?php
                $sql="SELECT * from producto INNER JOIN categoria ON producto.idCategoria = categoria.idCategoria WHERE categoria.nombreCateg LIKE 'Aceite'";
			...
			<form action="carrito.php" method="post">
				...
				<img src="imagenes/categoria/aceite/<?php echo $mostrar['idProducto']?>.jpg">
