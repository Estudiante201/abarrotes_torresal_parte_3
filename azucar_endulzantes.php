...
<header><label class="nombreParte1">Abarrotes</label>
    ...
    <section>
    	...
    	<center><h1 class="titulo_categoria">Categoria: Azúcar y Endulzantes</h1></center>
       <div class="container">
	   <?php
                $sql="SELECT * from producto INNER JOIN categoria ON producto.idCategoria = categoria.idCategoria WHERE categoria.nombreCateg LIKE 'Azúcar y Endulzantes'";
			...
			<form action="carrito.php" method="post">
				...
				<img src="imagenes/categoria/azucar_endulzantes/<?php echo $mostrar['idProducto']?>.jpg">
