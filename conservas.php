...
<header><label class="nombreParte1">Abarrotes</label>
    ...
    <section>
        <!-- Categoria: Conservas -->
    	<center><h1 class="titulo_categoria">Categoria: Conservas</h1></center>
       <div class="container">
	   <?php
                $sql="SELECT * from producto INNER JOIN categoria ON producto.idCategoria = categoria.idCategoria WHERE categoria.nombreCateg LIKE 'Conservas'";
			...
			<form action="carrito.php" method="post">
				...
				<img src="imagenes/categoria/conservas/<?php echo $mostrar['idProducto']?>.jpg">
