...
<header><label class="nombreParte1">Abarrotes</label>
    ...
    <section>
        <!-- Categoria: Fideos, Pastas y Salsas -->
    	<center><h1 class="titulo_categoria">Categoria: Fideos, Pastas y Salsas</h1></center>
       <div class="container">
	   <?php
                $sql="SELECT * from producto INNER JOIN categoria ON producto.idCategoria = categoria.idCategoria WHERE categoria.nombreCateg LIKE 'Fideos, Pastas y Salsas'";
			...
			<form action="carrito.php" method="post">
				...
				<img src="imagenes/categoria/fideos/<?php echo $mostrar['idProducto']?>.jpg">
